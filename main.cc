...
int main() {
  ...
  // load textures
  // -------------
  unsigned int woodTexture = loadTexture("resources/textures/container2.png", GL_CLAMP_TO_EDGE);
...
t glTexParameterfv(GL_TEXTURE_2D, GL_TEXTURE_BORDER_COLOR, borderColor);
