...
int main() {
  ...
  if (FT_New_Face(ft, "fonts/arial.ttf", 0, &face)) {
    printf("ERROR:FREETYPE: could not loat fonts/arial.ttf\n");
    return -1;
  }
  ...
  if (FT_Load_Char(face, 'X', FT_LOAD_RENDER)) {
    printf("ERROR:FREETYPE: failed to load Glyph 'X'\n");
    return -1;
  }
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    fprintf(stderr, "%lld\n", p.get_micros());
    RenderText(shader, "(C) LearnOpenGL.com", 1300.0f, 1140.0f, 0.5f, glm::vec3(0.3, 0.7f, 0.9f));
    fprintf(stderr, "%lld\n", p.get_micros());
